...
import com.yasserelgammal.newsapp.NewsApplication
import com.yasserelgammal.newsapp.model.Article
import com.yasserelgammal.newsapp.model.NewsResponse
...
class NewsViewModel(
    ...
    val connectivityManager = getApplication<NewsApplication>().getSystemService(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            val capapilites = connectivityManager.getNetworkCapabilities(activeNetwork) ?: return false
            return when {
                capapilites.hasTransport(TRANSPORT_WIFI) -> true
                capapilites.hasTransport(TRANSPORT_CELLULAR) -> true
                capapilites.hasTransport(TRANSPORT_ETHERNET) -> true
                else -> false
            }
            }else{
